...
This repository is forked from Master-of-Machines and contains the code and configuration for manually controlling a JetRacer ROS AI using a virtual joystick.
